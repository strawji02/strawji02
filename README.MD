AI 운동 코칭 앱 **Planfit**(한국 앱스토어 건강/피트니스 수익 1위)의 Lead Frontend Developer 황준혁입니다.

React Native 앱·웹 클라이언트와 AI 개발 워크플로우를 만들고 있습니다.
회사 작업은 private org에서 진행하고 있어, 이 프로필에는 개인 프로젝트 위주로 남아 있습니다.

## ✏️ Career

|    Type   |          Name          |    Date    |    Organization   |
|:---------:|:----------------------:|:----------:|:-----------------:|
| Work Experience | Lead Frontend Developer | 2025.04 ~ 현재 | Planfit (플랜핏) |
| Work Experience | Frontend Developer (Freelance) | 2024.02 ~ 2025.03 | 똑똑보카 |
| Work Experience | Frontend Developer | 2023.02 ~ 2023.12 | Fanplus (팬마음) |
| Work Experience | Frontend Developer | 2022.01 ~ 2023.01 | Itian (아이티언) |
| Education | Computer Engineering | 2020.03 ~ 2026.02 | Hongik University |
...
![ClaudeCode](https://img.shields.io/badge/Claude_Code-D97757?style=flat-square&logo=anthropic&logoColor=white)
...
* Planfit — React Native 앱 성능 최적화(cold-start 78~86% 단축), OTA 핫픽스 인프라, AI 개발 워크플로우 구축 및 전사 Claude Code 도입 (2025.04 ~)

* 똑똑보카 — 네이티브 앱 웹뷰·신규 유저 페이지 개발 (2024.02 ~ 2025.03)
...
### [**claude-session-monitor**](https://github.com/strawji02/claude-session-monitor)
![Typescript](https://img.shields.io/badge/Typescript-3178C6?style=flat-square&logo=typescript&logoColor=white)
![VSCode](https://img.shields.io/badge/VSCode_Extension-007ACC?style=flat-square&logo=visualstudiocode&logoColor=white)

> 여러 Claude Code CLI 세션의 상태(작업 중 / 입력 대기 / 권한 대기)를 한눈에 모니터링하는 VSCode 익스텐션. AI 병렬 작업 환경에서 "지금 내 판단이 필요한 세션"을 놓치지 않기 위해 직접 만든 도구
